...
import my_libs.tosshin.tosshin_scrape as tosshin
...
def run_tosshin_scraper():
    """Run the Tosshin scraper."""
    ...
    tosshin.scrape(keywords, OUTPUT_FOLDER)
    messagebox.showinfo(
        "Tosshin Scraper",
        "Tosshin scraper execution completed."
    )
